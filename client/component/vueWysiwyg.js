!(function(e, t) {
  ...
  return (function(e) {
    ...
    function(e, t, n) {
      ...
      var i = new function() {
        var e = {
          listeners: {},
          on: function(t, n) {
            void 0 === e.listeners[t] && (e.listeners[t] = []),
              e.listeners[t].push(n);
          },
          emit: function(t) {
            for (
              var n = arguments.length, i = Array(1 < n ? n - 1 : 0), o = 1;
              o < n;
              o++
            )
              i[o - 1] = arguments[o];
            void 0 !== e.listeners[t] &&
              e.listeners[t].forEach(function(e) {
                return e.apply(i);
              });
          }
        };
      ...
      (i.options = {
        image: { uploadURL: "None", dropzoneOptions: {} },
        hideModules: {},
      ...
      t.a = {
        ...
        computed: {
          ...
          modules: function() {
            ...
            return D.filter(function(t) {
              return (
                void 0 === e.mergedOptions.hideModules ||
                !e.mergedOptions.hideModules[t.title]
              );
            })
              .map(function(e) {
                return (
          ...
          btnsWithDashboards: function() {
            return this.modules
              ? this.modules.filter(function(e) {
                  return e.render;
                })
              : [];
          },
        ...
        methods: {
          saveSelection: function() {
            if (void 0 !== window.getSelection) {
              if (
                ...
                this.selection.getRangeAt && this.selection.rangeCount)
              )
          ...
          restoreSelection: function(e) {
            e &&
              (void 0 === window.getSelection
                ? document.selection && e.select && e.select()
                : ((this.selection = window.getSelection()),
          ...
          clearSelection: function() {
            ...
            var e = window.getSelection();
            e &&
              (void 0 !== e.empty && e.empty(),
              void 0 !== e.removeAllRanges && e.removeAllRanges());
          },
          exec: function(e, t, n) {
            !1 !== n && this.selection && this.restoreSelection(this.selection),
          ...
          onDocumentClick: function(e) {
            for (var t, n = 0; n < this.btnsWithDashboards.length; n++)
              (t = this.$refs["btn-" + this.btnsWithDashboards[n].title][0]) &&
                t.showDashboard &&
      ...
      t.a = {
        ...
        methods: {
          ...
          onBtnClick: function(e) {
            var t = this;
            if ((e.preventDefault(), void 0 !== this.module.action))
              this.exec.apply(null, this.module.action);
            else if (void 0 !== this.module.customAction)
              this.module.customAction(i.a.utils).forEach(function(e) {
                return t.exec.apply(null, e);
              });
            else if (
              !(
                void 0 === this.module.render ||
                (this.$refs.dashboard &&
                  this.$refs.dashboard.contains(e.target))
              )
            )
              return (
      ...
      t.a = {
        ...
        methods: {
          insertTable: function() {
            var e = ("<tr>" + "<td></td>".repeat(this.cols) + "</tr>").repeat(
              this.rows
            );
            this.$emit(
              "exec",
    ...
    function(e, t, n) {
      e.exports = { default: n(21), __esModule: !0 };
    },
    function(e, t, n) {
    ...
    function(e, t, n) {
      ...
      e.exports =
        ...
        n(6)(function() {
          ...
          ? function(e, t) {
              for (
                var n = s(e), l = arguments.length, u = 1, c = o.f, d = r.f;
                l > u;
    ...
    function(e, t) {
      e.exports = function(e, t, n) {
        ...
        function l() {
          ...
          u < t && u >= 0
            ? (i = setTimeout(l, t - u))
            : ((i = null), n || ((a = e.apply(r, o)), (r = o = null)));
        }
        null == t && (t = 100);
        var u = function() {
    ...
    function(e, t, n) {
      ...
      var i = function() {
          var e = this,
            t = e.$createElement,
            n = e._self._c || t;
          return n("div", { on: { mousedown: e.onBtnClick } }, [
            n("a", {
              class: "vw-btn-" + e.module.title,
              domProps: { innerHTML: e._s(e.module.icon) }
            }),
            n(
              "div",
              {
        ...
        o = [
          function() {
            ...
            return (this._self._c || e)(this.module, {
              ref: "moduleDashboard",
              tag: "component",
              attrs: { uid: this.uid, options: this.options },
              on: { exec: this.exec }
            });
          }
        ];
    ...
    function(e, t) {
      e.exports = {
        ...
        icon:
          '<svg viewBox="0 0 1792 1792" xmlns="http://www.w3.org/2000/svg"><path d="M1792 1344v128q0 26-19 45t-45 19h-1664q-26 0-45-19t-19-45v-128q0-26 19-45t45-19h1664q26 0 45 19t19 45zm0-384v128q0 26-19 45t-45 19h-1280q-26 0-45-19t-19-45v-128q0-26 19-45t45-19h1280q26 0 45 19t19 45zm0-384v128q0 26-19 45t-45 19h-1536q-26 0-45-19t-19-45v-128q0-26 19-45t45-19h1536q26 0 45 19t19 45zm0-384v128q0 26-19 45t-45 19h-1152q-26 0-45-19t-19-45v-128q0-26 19-45t45-19h1152q26 0 45 19t19 45z"/></svg>'
      };
    },
    function(e, t, n) {
      "use strict";
    ...
    function(e, t, n) {
      ...
      var i = function() {
          ...
          return n("div", [
            n(
              "button",
              { attrs: { type: "button" }, on: { click: e.insertHeading } },
              [e._v("H1")]
            ),
            e._v(" "),
            n(
      ...
      var i = function() {
          ...
          return n(
            ...
            [
              ...
              e._v(" "),
              n("button", { attrs: { type: "submit" } }, [e._v("Insert")])
            ]
          );
        },
        o = [];
    ...
    function(e, t) {
      e.exports = {
        title: "code",
        icon:
          '<svg height="1792" viewBox="0 0 1792 1792" width="1792" xmlns="http://www.w3.org/2000/svg"><path d="M553 1399l-50 50q-10 10-23 10t-23-10l-466-466q-10-10-10-23t10-23l466-466q10-10 23-10t23 10l50 50q10 10 10 23t-10 23l-393 393 393 393q10 10 10 23t-10 23zm591-1067l-373 1291q-4 13-15.5 19.5t-23.5 2.5l-62-17q-13-4-19.5-15.5t-2.5-24.5l373-1291q4-13 15.5-19.5t23.5-2.5l62 17q13 4 19.5 15.5t2.5 24.5zm657 651l-466 466q-10 10-23 10t-23-10l-50-50q-10-10-10-23t10-23l393-393-393-393q-10-10-10-23t10-23l50-50q10-10 23-10t23 10l466 466q10 10 10 23t-10 23z"/></svg>',
        description: "Code",
      ...
      (i = function() {
        ...
        var e = {
          getSignedURL: function(e, t) {
            var n = { filePath: e.name, contentType: e.type };
            return new Promise(function(i, o) {
              var r = new FormData(),
                s = new XMLHttpRequest(),
                a =
                  "function" == typeof t.signingURL
                    ? t.signingURL(e)
                    : t.signingURL;
              s.open("POST", a),
                (s.onload = function() {
              ...
              .then(function(t) {
                ...
                return (
                  ...
                  new Promise(function(e, i) {
                    ...
                    o.open("POST", t.postEndpoint),
                      (o.onload = function() {
                        if (201 == o.status) {
                          var t = new window.DOMParser().parseFromString(
                            o.response,
                            "text/xml"
                          ).firstChild.children[0].innerHTML;
                          e({ success: !0, message: t });
                        } else {
                      ...
                      (o.onerror = function(e) {
                        var t = new window.DOMParser().parseFromString(
                          o.response,
                          "text/xml"
                        ).firstChild.children[1].innerHTML;
                        i({ success: !1, message: t });
                      }),
                      o.send(n);
                  })
                );
        ...
        return {
          render: function() {
            ...
            return (e._self._c || t)("div", {
              ref: "dropzoneElement",
              class: { "vue-dropzone dropzone": e.includeStyling },
              attrs: { id: e.id }
            });
          },
          staticRenderFns: [],
          ...
          data: function() {
            return { isS3: !1, wasQueueAutoProcess: !0 };
          },
          computed: {
            dropzoneSettings: function() {
              var e = { thumbnailWidth: 200, thumbnailHeight: 200 };
              return (
                ...
                null !== this.awss3 &&
                  ...
                  (this.isS3 = !0),
                  void 0 !== this.options.autoProcessQueue &&
          ...
          methods: {
            ...
            processQueue: function() {
              ...
              this.isS3 && !this.wasQueueAutoProcess
                ? this.getQueuedFiles().forEach(function(t) {
            ...
            getSignedAndUploadToS3: function(t) {
              var n = this;
              e.sendFile(t, this.awss3)
                .then(function(e) {
                  e.success
                    ? ((t.s3ObjectLocation = e.message),
                      setTimeout(function() {
                        return n.dropzone.processFile(t);
                      }),
                      n.$emit("vdropzone-s3-upload-success", e.message))
                    : "undefined" != typeof message
                    ? n.$emit("vdropzone-s3-upload-error", e.message)
                    : n.$emit(
            ...
            if (!this.$isServer || !this.hasBeenMounted) {
              ...
              this.dropzone.on("thumbnail", function(e, n) {
                ...
                this.dropzone.on("addedfile", function(e) {
                  t.duplicateCheck &&
                    ...
                    this.files.forEach(function(n) {
                      n.name === e.name &&
                        (this.removeFile(e), t.$emit("duplicate-file", e));
                    }, this),
                    t.$emit("vdropzone-file-added", e),
                    t.isS3 &&
                      t.wasQueueAutoProcess &&
                ...
                this.dropzone.on("removedfile", function(e) {
                  t.$emit("vdropzone-removed-file", e),
                    e.manuallyAdded && t.dropzone.options.maxFiles++;
                }),
                this.dropzone.on("success", function(e, n) {
                  t.$emit("vdropzone-success", e, n),
                    t.isS3 &&
                      t.wasQueueAutoProcess &&
                      t.setOption("autoProcessQueue", !1);
                }),
                ...
                this.dropzone.on("sending", function(e, n, i) {
                  t.isS3 && i.append("s3ObjectLocation", e.s3ObjectLocation),
                    t.$emit("vdropzone-sending", e, n, i);
                }),
    ...
    function(e, t, n) {
      ...
      (function(e) {
          ...
          r = (function(e) {
            function r(e, t) {
              ...
              if (
                ...
                s.options.forceFallback || !r.isBrowserSupported())
              )
                return (l = s.options.fallback.call(s)), n(s, l);
              if (
                (null == s.options.url &&
                  (s.options.url = s.element.getAttribute("action")),
                !s.options.url)
              )
              ...
              return (
                s.options.acceptedMimeTypes &&
                  ((s.options.acceptedFiles = s.options.acceptedMimeTypes),
                  delete s.options.acceptedMimeTypes),
                null != s.options.renameFilename &&
                  (s.options.renameFile = function(e) {
                    return s.options.renameFilename.call(s, e.name, e);
                  }),
                (s.options.method = s.options.method.toUpperCase()),
                (a = s.getExistingFallback()) &&
                  a.parentNode &&
                  a.parentNode.removeChild(a),
                !1 !== s.options.previewsContainer &&
                  (s.options.previewsContainer
                    ? (s.previewsContainer = r.getElement(
                        s.options.previewsContainer,
                        "previewsContainer"
                      ))
                    : (s.previewsContainer = s.element)),
                s.options.clickable &&
                  (!0 === s.options.clickable
                    ? (s.clickableElements = [s.element])
                    : (s.clickableElements = r.getElements(
                        s.options.clickable,
                        "clickable"
                      ))),
                s.init(),
                    ...
                    (this.prototype.Emitter = o),
                      ...
                      (this.prototype.defaultOptions = {
                        ...
                        fallback: function() {
                          ...
                          for (
                            var t = 0,
                              n = (n = this.element.getElementsByTagName(
                                "div"
                              ));
                            ;
                          ...
                          if (
                            ...
                            for (
                              var l = function(n) {
                                ...
                                u = 0,
                                c = (c = e.previewElement.querySelectorAll(
                                  "[data-dz-remove]"
                                ));
                              ;
                ...
                [
                  ...
                  },
                  {
                    ...
                    value: function() {
                      return this.files
                        .filter(function(e) {
                          return (
                            e.status === r.UPLOADING || e.status === r.QUEUED
                          );
                        })
                        .map(function(e) {
                          return e;
                      ...
                      if (
                        ...
                        !(function t() {
                          return (
                            ...
                            (e.hiddenFileInput = document.createElement(
                              "input"
                            )),
                      ...
                      if (e > 0) {
                        for (
                          ...
                          if (
                            ...
                            (t =
                              e / Math.pow(this.options.filesizeBase, 4 - o)),
                              (n = r);
                            break;
                          }
                        }
                    ...
                    value: function(e) {
                      ...
                      return (function() {
                        for (var n = [], i = 0, o = (o = e); ; ) {
                          ...
                          (r = s.webkitGetAsEntry())
                            ? r.isFile
                              ? n.push(t.addFile(s.getAsFile()))
                              : r.isDirectory
                              ? n.push(t._addFilesFromDirectory(r, r.name))
                              : n.push(void 0)
                            : null != s.getAsFile &&
                          ...
                          if (i.length > 0) {
                            for (var o = 0, r = (r = i); !(o >= r.length); ) {
                              ...
                              s.isFile
                                ...
                                : s.isDirectory &&
                                  n._addFilesFromDirectory(s, t + "/" + s.name);
                            }
                            e();
                          }
                          return null;
                  ...
                  },
                  {
                    ...
                    value: function(e) {
                      ...
                      if (
                        ((e.status = r.QUEUED), this.options.autoProcessQueue)
                      )
                        return setTimeout(function() {
                  ...
                  },
                  {
                    ...
                    value: function(e, t, n, i, o) {
                      var s = this;
                      return this.createThumbnail(e, t, n, i, !1, function(
                        t,
                        n
                      ) {
                        ...
                        return (
                          ("image/jpeg" !== i && "image/jpg" !== i) ||
                            (a = u.restore(e.dataURL, a)),
                          o(r.dataURItoBlob(a))
                        );
                      });
                    }
                  },
                  {
                    ...
                    value: function(e, t, n, i, o, r) {
                      ...
                      return (
                        (a.onload = function() {
                          if (
                            ((e.dataURL = a.result), "image/svg+xml" !== e.type)
                          )
                            return s.createThumbnailFromUrl(e, t, n, i, o, r);
                          null != r && r(a.result);
                        }),
                        a.readAsDataURL(e)
                      );
                  ...
                  },
                  {
                    ...
                    value: function(e) {
                      if (e.status === r.UPLOADING) {
                        ...
                        (e.status !== r.ADDED && e.status !== r.QUEUED) ||
                          ((e.status = r.CANCELED),
                        ...
                        if (e[0].upload.chunked) {
                          ...
                          if (
                            ((i.upload.finishedChunkUpload = function(n) {
                              ...
                              for (
                                var a = 0;
                                a < i.upload.totalChunkCount;
                                a++
                              ) {
                                if (void 0 === i.upload.chunks[a]) return s();
                                i.upload.chunks[a].status !== r.SUCCESS &&
                                  (o = !1);
                              }
                              o &&
                  ...
                  },
                  {
                    ...
                    value: function(e, t) {
                      ...
                      for (var c in (this.options.headers &&
                        r.extend(u, this.options.headers),
                      u)) {
                        var d = u[c];
                        ...
                        if (
                          ...
                          for (var s = 0; s < o.upload.totalChunkCount; s++)
                            void 0 !== o.upload.chunks[s] &&
                              ...
                              ((o.upload.progress +=
                                o.upload.chunks[s].progress),
                              (o.upload.total += o.upload.chunks[s].total),
                              (o.upload.bytesSent +=
                                o.upload.chunks[s].bytesSent));
                          o.upload.progress =
        ...
        r.initClass(),
          (r.version = "5.3.0"),
          (r.options = {}),
          (r.optionsForElement = function(e) {
            return e.getAttribute("id")
              ? r.options[a(e.getAttribute("id"))]
              : void 0;
          }),
          (r.instances = []),
          ...
          (r.isBrowserSupported = function() {
            ...
            if (
              ...
              if ("classList" in document.createElement("a"))
                for (var t = 0, n = (n = r.blacklistedBrowsers); ; ) {
                  if (t >= n.length) break;
        ...
        (r.createElement = function(e) {
          ...
          (r.getElements = function(e, t) {
            ...
            if (e instanceof Array) {
              ...
              i = [];
              for (
                var s = 0, a = (a = document.querySelectorAll(e));
                !(s >= a.length);
          ...
          (r.isValidFile = function(e, t) {
            ...
            t = t.split(",");
            for (
              var n = e.type, i = n.replace(/\/.*$/, ""), o = 0, r = (r = t);
              ;
              ...
              if ("." === (s = s.trim()).charAt(0)) {
                if (
                  ...
                  e.name
                    .toLowerCase()
                    .indexOf(s.toLowerCase(), e.name.length - s.length)
                )
                  return !0;
              } else if (/\/\*$/.test(s)) {
          ...
          void 0 !== e && null !== e ? (e.exports = r) : (window.Dropzone = r),
          (r.ADDED = "added"),
          (r.QUEUED = "queued"),
          (r.ACCEPTED = r.QUEUED),
        ...
        var l = function(e, t, n, i, o, r, s, a, l, u) {
            var c = (function(e) {
              ...
              i.drawImage(e, 0, 0);
              for (
                var o = i.getImageData(1, 0, 1, t).data, r = 0, s = t, a = t;
                a > r;
                ...
                },
                {
                  ...
                  value: function(e) {
                    ...
                    for (
                      ...
                      (t =
                        (this.KEY_STR.indexOf(e.charAt(a++)) << 2) |
                        ((o = this.KEY_STR.indexOf(e.charAt(a++))) >> 4)),
                        (n =
                          ((15 & o) << 4) |
                          ((r = this.KEY_STR.indexOf(e.charAt(a++))) >> 2)),
                        (i =
                          ((3 & r) << 6) |
        ...
        (r._autoDiscoverFunction = function() {
          ...
          (function(e, t) {
            var n = !1,
              ...
              u = function i(r) {
                if (
                  ...
                  return (
                    ("load" === r.type ? e : o)[a](l + r.type, i, !1),
                    !n && (n = !0) ? t.call(e, r.type || r) : void 0
                  );
              };
            if ("complete" !== o.readyState) {
              ...
              o[s](l + "DOMContentLoaded", u, !1),
                o[s](l + "readystatechange", u, !1),
                e[s](l + "load", u, !1);
            }
    ...
    function(e, t) {
      e.exports = { title: "separator", icon: "<i class='vw-separator'></i>" };
    },
    function(e, t, n) {
      "use strict";
      n.d(t, "a", function() {
      ...
      var i = function() {
          var e = this,
            t = e.$createElement,
            n = e._self._c || t;
          return n("div", { staticClass: "editr" }, [
            n(
              "div",
